...
///
/// This should only be used if you need to terminate终止 the bind early, or close
/// over some state. -flattenMap: is more appropriate合适的 for all other cases.
///
...
///         nil or return nil.
///
/// Returns a new stream which represents相当于 the combined result of all lazy
