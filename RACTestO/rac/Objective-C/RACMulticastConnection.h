...
/// A multicast connection encapsulates压缩 the idea of sharing one subscription to a
/// signal to many subscribers. This is most often needed if the subscription to
/// the underlying潜在的 signal involves side-effects or shouldn't be called more than
/// once.
///
